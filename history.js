...
// Učitaj istoriju treninga sa servera sa apsolutnim domenom
function loadTrainingHistory() {
    fetch(`https://www.kkrad.com/api/players/${playerName}/trening`)
        ...
        .catch((error) =>
            console.error("Greška prilikom učitavanja treninga:", error),
        );
}

function loadMatchHistory() {
    fetch(`https://www.kkrad.com/api/players/${playerName}/utakmica`)
        .then((response) => response.json())
        .then((data) => {
        ...
        .catch((error) =>
            console.error("Greška prilikom učitavanja utakmica:", error),
        );
}

function updateTrainingTable() {
    const trainingTable = document
        .getElementById("training-history")
